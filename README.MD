...
**備用地址**: [https://yanchen184.github.io/workout-calendar/](https://yanchen184.github.io/workout-calendar/)
...
### GitHub Actions 自動部署
- 推送到 `master` 分支時自動觸發
- 自動建構並部署到 GitHub Pages
- 同時部署到 `gh-pages` 分支作為備用
